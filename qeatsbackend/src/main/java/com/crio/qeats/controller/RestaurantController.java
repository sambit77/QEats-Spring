...
public class RestaurantController {
  ...
  public ResponseEntity<GetRestaurantsResponse> getRestaurants(@Valid GetRestaurantsRequest getRestaurantsRequest) throws InterruptedException, ExecutionException {
    ...
    System.out.println("API Call "+ getRestaurantsRequest.toString());
    if(getRestaurantsRequest.getSearchFor() != null)
    {
      getRestaurantsResponse = restaurantService.findRestaurantsBySearchQuery(getRestaurantsRequest, LocalTime.of(18,00));
      //getRestaurantsResponse = restaurantService.findRestaurantsBySearchQueryMt(getRestaurantsRequest, LocalTime.of(18, 00));
    }
    else
    {
      getRestaurantsResponse = restaurantService.findAllRestaurantsCloseBy(getRestaurantsRequest, LocalTime.of(18,00));
    }
      // CHECKSTYLE:OFF  
