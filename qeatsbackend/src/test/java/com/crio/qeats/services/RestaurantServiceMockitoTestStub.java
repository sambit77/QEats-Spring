...
public class RestaurantServiceMockitoTestStub {
  ...
  public List<Restaurant> restaurantList1 = new ArrayList<>();
  public List<Restaurant> restaurantList2 = new ArrayList<>();
  ...
  public void  testFindNearbyWithin5km() throws IOException {
    ...
    /*lenient().doReturn(Arrays.asList(restaurant1, restaurant2)).when(restaurantRepositoryServiceMock.findAllRestaurantsCloseBy(any(Double.class), any(Double.class),
    eq(LocalTime.of(3, 0)),
    any(Double.class)));*/

     when(restaurantRepositoryServiceMock.findAllRestaurantsCloseBy(any(Double.class), any(Double.class),
                eq(LocalTime.of(3, 0)),
                any(Double.class))).thenReturn(Arrays.asList(restaurant1, restaurant2));
  ...
  public void  testFindNearbyWithin3km() throws IOException {
    ...
    // java.util.ArrayList<Restaurant> restaurantList1 = new java.util.ArrayList()<Restaurant>;
    // java.util.ArrayList<Restaurant> restaurantList2 = new java.util.ArrayList()<Restaurant>();
    ...
    lenient().doReturn(Arrays.asList(restaurant2,restaurant4))
        .when(restaurantRepositoryServiceMock)
